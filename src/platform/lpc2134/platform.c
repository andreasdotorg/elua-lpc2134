...
int platform_init()
{
  ...
  platform_setup_adcs();
#endif
  platform_uart_send(0, 'd');

  // Common platform initialization code
  cmn_platform_init();

  platform_uart_send(0, 'e');
  return PLATFORM_OK;
} 
...
static const u32 pio_fiodir[ NUM_PIO ] = { ( u32 )&FIO0DIR, ( u32 )&FIO1DIR };
static const u32 pio_fiopin[ NUM_PIO ] = { ( u32 )&FIO0PIN, ( u32 )&FIO1PIN };
static const u32 pio_fioset[ NUM_PIO ] = { ( u32 )&FIO0SET, ( u32 )&FIO1SET };
static const u32 pio_fioclr[ NUM_PIO ] = { ( u32 )&FIO0CLR, ( u32 )&FIO1CLR };
...
// by the user
static const u32 uart_lcr[ NUM_UART ] = { ( u32 )&U0LCR, ( u32 )&U1LCR };
static const u32 uart_dlm[ NUM_UART ] = { ( u32 )&U0DLM, ( u32 )&U1DLM };
static const u32 uart_dll[ NUM_UART ] = { ( u32 )&U0DLL, ( u32 )&U1DLL };
static const u32 uart_fcr[ NUM_UART ] = { ( u32 )&U0FCR, ( u32 )&U1FCR };
static const u32 uart_thr[ NUM_UART ] = { ( u32 )&U0THR, ( u32 )&U1THR };
static const u32 uart_lsr[ NUM_UART ] = { ( u32 )&U0LSR, ( u32 )&U1LSR };
static const u32 uart_rbr[ NUM_UART ] = { ( u32 )&U0RBR, ( u32 )&U1RBR };
static const u32 uart_fdr[ NUM_UART ] = { ( u32 )&U0FDR, ( u32 )&U1FDR };
...
static const u32 tmr_tcr[] = { ( u32 )&T0TCR, ( u32 )&T1TCR };
static const u32 tmr_tc[] = { ( u32 )&T0TC, ( u32 )&T1TC };
static const u32 tmr_pr[] = { ( u32 )&T0PR, ( u32 )&T1PR };
static const u32 tmr_pc[] = { ( u32 )&T0PC, ( u32 )&T1PC };
static const u32 tmr_mr1[] = { ( u32 )&T0MR1, ( u32 )&T1MR1 };
static const u32 tmr_mcr[] = { ( u32 )&T0MCR, ( u32 )&T1MCR };
static const u32 tmr_emr[] = { ( u32 )&T0EMR, ( u32 )&T1EMR };
...
static void platform_setup_timers()
{
  ...
  T1TCR = TMR_RESET;
  T1MR0 = 1000000ULL / VTMR_FREQ_HZ - 1;
  T1IR = 0xFF;
  // Set interrupt handle and eanble timer interrupt (and global interrupts)
  T1MCR = 0x03; // interrupt on match with MR0 and clear on match
  install_irq( TIMER1_INT, tmr_int_handler, HIGHEST_PRIORITY ); 
...
static const u32 adc_dr[] = { ( u32 )&AD0DR0, ( u32 )&AD0DR1 };
...
static const u32 pwm_tcr[] = { ( u32 )&PWMTCR };
static const u32 pwm_pr[] = { ( u32 )&PWMPR };
static const u32 pwm_pc[] = { ( u32 )&PWMPC };
static const u32 pwm_pcr[] = { ( u32 )&PWMPCR };
static const u32 pwm_mcr[] = { ( u32 )&PWMMCR };
static const u32 pwm_ler[] = { ( u32 )&PWMLER };
static const u32 pwm_channels[ 1 ][ 6 ] = 
{
  { ( u32 )&PWMMR1, ( u32 )&PWMMR2, ( u32 )&PWMMR3, ( u32 )&PWMMR4, ( u32 )&PWMMR5, ( u32 )&PWMMR6 },
};
